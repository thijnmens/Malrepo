		...
		<div>
			...
			<main className="w-[60%] m-auto">
				<div className="text-center">
					<br />
					<h1 className="font-extrabold">Website Terms of Use</h1>
					<br />
					<p>Version 1.0</p>
					<br />
					<p>
						The malrepo website located at https://malrepo.net is a copyrighted work
						belonging to malrepo. Certain features of the Site may be subject to
					...
					<p>
						...
						the event of a dispute. These Terms of Use were created with the help of the{' '}
						<a href="https://www.termsofusegenerator.net">Terms Of Use Generator</a>.
					</p>
					<br />
					<h2 className="font-bold">Access to the Site</h2>
					<br />
					<p>
					...
					<p>
						...
						that is in violation of any law, regulation, or obligations or restrictions
						imposed by any third party.
					</p>
					<br />
					<p>
						In addition, you agree not to: (i) upload, transmit, or distribute to or
						through the Site any software intended to damage or alter a computer system
						or data; (ii) send through the Site unsolicited or unauthorized advertising,
						promotional materials, junk mail, spam, chain letters, pyramid schemes, or
						any other form of duplicative or unsolicited messages; (iii) use the Site to
						harvest, collect, gather or assemble information or data regarding other
						users without their consent; (iv) interfere with, disrupt, or create an
					...
					<p>
						...
						the Acceptable Use Policy or any other provision of these Terms or otherwise
						create liability for us or any other person. Such action may include
					...
					<p>
						...
						related information in any manner it believes appropriate. Company will
					...
					<p>
						...
						these claims. You agree not to settle any matter without the prior written
						consent of Company. Company will use reasonable efforts to notify you of any
						such claim, action or proceeding upon becoming aware of it.
					</p>
					<br />
					<h2 className="font-bold">Third-Party Links & Ads; Other Users</h2>
					<br />
					<p>
					...
					<p>
						...
						and all of its own User Content. Because we do not control User Content, you
					...
					<p>
						...
						third-party vendor on our site. It also uses cookies, known as DART cookies,
					...
					<br />
					<h2 className="font-bold">Limitation on Liability</h2>
					<br />
					<p>
					...
					<p>
						...
						Content associated with your Account from our live databases. Company will
						...
						the following provisions of these Terms will remain in effect: Sections 2
						through 2.5, Section 3 and Sections 4 through 10.
					</p>
					<br />
					<h2 className="font-bold">Copyright Policy.</h2>
					<br />
					<p>
					...
					<p>
						...
						the changes on our Site. You are responsible for providing us with your most
						current e-mail address. In the event that the last e-mail address that you
						have provided us is not valid our dispatch of the e-mail containing such
					...
					<p>
						...
						be sent to: karthuizerserf 2, Helmond, The Netherlands. After the Notice is
					...
					<p>
						...
						resolution provider that offers arbitration as set forth in this section. If
						...
						be determined by the Arbitration Rules. Any hearing will be held in a
						...
						outside of the U.S., the arbitrator shall give the parties reasonable notice
						of the date, time and place of any oral hearings. Any judgment on the award
						rendered by the arbitrator may be entered in any court of competent
						jurisdiction. If the arbitrator grants you an award that is greater than the
						last settlement offer that the Company made to you prior to the initiation
						of arbitration, the Company will pay you the greater of the award or
						$2,500.00. Each party shall bear its own costs and disbursements arising out
					...
					<p>
						...
						with any other cases or parties. The arbitrator shall have the authority to
						grant motions dispositive of all or part of any claim. The arbitrator shall
					...
					<p>
						...
						Affairs by contacting them in writing at 400 R Street, Sacramento, CA 95814,
					...
					<br />
					<p>Address: karthuizerserf 2, Helmond, The Netherlands</p>
					<p>Email: thijnsmulders04@gmail.com</p>
				</div>
			</main>
		</div>
	);
