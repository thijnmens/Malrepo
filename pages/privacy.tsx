		...
		<div>
			...
			<main className="w-[60%] m-auto">
				<div className="text-center">
					<br />
					<h1 className="font-extrabold">Privacy Policy for malrepo</h1>
					<br />
					<p>
						At malrepo, accessible from https://malrepo.net, one of our main priorities
						is the privacy of our visitors. This Privacy Policy document contains types
						of information that is collected and recorded by malrepo and how we use it.
					</p>
					<br />
					<p>
					...
					<p>
						...
						and/or collect in malrepo. This policy is not applicable to any information
					...
					<br />
					<p>
						malrepo follows a standard procedure of using log files. These files log
					...
					<br />
					<p>
						Like any other website, malrepo uses 'cookies'. These cookies are used to
					...
					<br />
					<h2 className="font-bold">Google DoubleClick DART Cookie</h2>
					<br />
					<p>
					...
					<p>
						...
						advertising partners of malrepo.
					</p>
					<br />
					<p>
						Third-party ad servers or ad networks uses technologies like cookies,
						JavaScript, or Web Beacons that are used in their respective advertisements
						and links that appear on malrepo, which are sent directly to users' browser.
					...
					<br />
					<p>
						Note that malrepo has no access to or control over these cookies that are
					...
					<br />
					<p>
						malrepo's Privacy Policy does not apply to other advertisers or websites.
					...
					<br />
					<p>
						malrepo does not knowingly collect any Personal Identifiable Information
